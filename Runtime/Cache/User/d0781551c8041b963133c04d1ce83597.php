...
<title>约谈的项目 - 会员中心芝麻乐开源众筹系统</title>
...
<?php if(is_array($interview)): $i = 0; $__LIST__ = $interview;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zml): $mod = ($i % 2 );++$i;?><div class="x12 bg padding">
		...
		<div class="x9 bg padding bg-white border-left height-big">
			<div><span class="x6 text-big"><a href="<?php echo U('Home/Item/Info',array('id'=>$zml['id']));?>"><?php echo ($zml["item_name"]); ?></a></span><span class="x6 text-right"><button class="button radius-none bg-red"><?php echo ($zml["progress_name"]); ?>中</button><button class="button radius-none bg-yellow margin-left"><?php echo ($zml["status"]); ?></button></span></div>
			<div class="x12 text-gray">
				<div class="x6">
					<span class="x12">融资总额: <span class="text-red">￥<?php echo ($zml["raising_money"]); ?></span></span>
				</div>
				<div class="x6">
					<span class="x12">投资方占比: <span class="text-red"><?php echo ($zml["investment_rate"]); ?>%</span></span>
				</div>
			</div>
			<div class="x12 text-gray">
				<div class="x6">
					<span class="x12">最低投资: <span class="text-red">￥<?php echo ($zml["lowest_money"]); ?></span></span>
				</div>
				<div class="x6">
					<span class="x12">已完成: <span class="text-red"><?php echo ($zml["investment_rate"]); ?>%</span></span>
				</div>
			</div>
		</div>
