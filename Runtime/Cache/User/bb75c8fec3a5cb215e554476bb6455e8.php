...
<div class="padding  x12">
	...
	<div class="bg padding ">用户基本信息</div>	
		...
		<div class="height-large padding border-bottom x12">
			...
			<a href="/index.php/User/Info/edit_phone" class="text-blue" >修改</a>
		</div>
		<div class="height-large padding border-bottom x12">
		...
		<div class="height-large padding border-bottom x12">
			...
			<span class="x9" id="desc">
				<select name="province" class="input input-auto"  id="province" onchange="loadRegion('province',2,'city','/index.php/User/Region/index');">
				...
				<select name="city" class="input input-auto " id="city" data-validate="required:请选择城市"  onchange="loadRegion('city',3,'area','/index.php/User/Region/index');">
...
function saveaddress(d){
	...
	$.post('/index.php/User/Info/edit',{province:prov,city:city,area:area,address:address},function(e){
		$("#address").val(address);
...
function save(name,d,value){
	...
	if(name=='name'){
		$.post('/index.php/User/Info/edit',{name:v},function(e){
			if(e.status=1){
				$(d).parent().text(v);
				layer.msg('更新成功', {shift: 2});
			}else{
		...
		$.post('/index.php/User/Info/edit',{age:v},function(e){
			if(e.status=1){
				$(d).parent().text(v);
				layer.msg('更新成功', {shift: 2});
			}else{
		...
		$.post('/index.php/User/Info/edit',{header:value},function(e){
			if(e.status=1){
				layer.msg('更新成功', {shift: 2});
			}else{
				layer.msg('更新失败', {shift: 2});
...
function savesex(v,d){
	$.post('/index.php/User/Info/edit',{sex:v},function(e){
			if(e.status=1){
				layer.msg('更新成功', {shift: 2});
			}else{
				layer.msg('更新失败', {shift: 2});
