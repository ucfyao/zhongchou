...
<title>跟投的项目 - 会员中心芝麻乐开源众筹系统</title>
...
<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zml): $mod = ($i % 2 );++$i;?><div class="x12 bg padding">
		<div class="x3 padding  bg-white">
			<img src="<?php echo ($zml["item_info"]["cover_img"]); ?>" alt="<?php echo ($zml["item_info"]["name"]); ?>" class="x12" height="94">
		</div>
		<div class="x9 bg padding bg-white border-left height-big">
			<div>
				<span class="x6 text-big"><?php echo ($zml["item_info"]["name"]); ?></span>
				<span class="x6 text-right text-small"><?php echo (date("Y-m-d H:i:s",$zml["create_time"])); ?></span>
			</div>
			<div class="x12 text-gray">
				<div class="x6">
					<span class="x12">融资总额: <span class="text-red">￥<?php echo ($zml["item_info"]["raising_money"]); ?></span></span>
				</div>
				<div class="x6">
					<span class="x12">投资金额: <span class="text-red">￥<?php echo ($zml["money"]); ?></span></span>
				</div>
			</div>
			<div class="x12 text-gray">
				<div class="x6">
					<span class="x12">最低投资: <span class="text-red">￥<?php echo ($zml["item_info"]["lowest_money"]); ?></span></span>
				</div>
				<div class="x6">
					<span class="x12">投资份数: <span class="text-red"><?php echo ($zml["amount"]); ?>份</span></span>
				</div>
			</div>
		</div>
