...
<div class="x12">
	...
	<div class="x12 float-right bg-white padding">
		...
		<div class="form-group">
			  ...
			  <div class="field field-icon">	
				<span class="padding-small-top icon icon-check-square-o"></span>
				  ...
				  <span class="addbtn padding-left"><img src="<?php echo U('/Home/Verify');?>" id="code" width="80" height="35"/></span>
		...
		<div class="x12 margin-top">
			<span>还没有账号 ? 【<a href="/index.php/User/Login/reg" class="text-blue">注册账号</a>】</span>
			<span><a href="/index.php/User/Login/forgotpwd" class="text-blue">忘记密码 ? </a></span>
		</div>
	</div> 
</div>
	<script>
		function verifys(id){
			document.getElementById(id).src="<?php echo U('/Home/Verify');?>?"+Math.random(); 
