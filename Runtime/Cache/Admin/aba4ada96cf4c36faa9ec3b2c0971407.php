...
layer.config({
	...
	<script>
		function node_add(){
			layer.open({
				...
				maxmin: true,
				title:'创建节点',
				content: '/index.php/Admin/Auth/node_add'
			});
		}
	//编辑节点
	function editnode(id){	
		layer.open({
			...
			maxmin: true,
			title:'创建节点',
			content: '/index.php/Admin/Auth/node_edit/id/'+id
		});
	}
	</script>
  	<!-- 底部 -->
