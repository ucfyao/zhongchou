	...
	<div class="padding  x12">
		<div class="border x12">
			...
			<div class="x10 padding text-center">
				<a href="/index.php/Admin/Item/item_add/itemid/<?php echo ($itemid); ?>/set/2.html" class="button button-big bg-red" >上一步</a>
...
function save(d){
	...
	$.post('/index.php/Admin/Item/item_in_third',{
