...
$(function(){
    $('.config').click(function(){
        ...
        layer.open({
			...
			//maxmin: true,
			title:title+'配置',
			content: '<?php echo U('Admin/System/payment_set');?>?type='+type
		});
    });
})
	...
	$('.status').click(function(){
		...
		parent.layer.confirm('确定进行'+title+'？', {icon: 3},function(){
	        layer.open({
				...
				//maxmin: true,
				title:title,
				content: '<?php echo U('Admin/System/payment_status');?>?type='+type+'&status='+status
			});
	    });
    });
})
