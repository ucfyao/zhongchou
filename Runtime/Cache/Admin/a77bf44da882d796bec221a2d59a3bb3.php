	...
	<script>
		...
		function role_add(){
			layer.open({
				...
				maxmin: true,
				title:'创建角色',
				content: '/index.php/Admin/Auth/role_add'
			});
		}
		//编辑角色
		function role_edit(id){
			layer.open({
				...
				maxmin: true,
				title:'编辑角色',
				content: '/index.php/Admin/Auth/role_edit/id/'+id
			});
		}
