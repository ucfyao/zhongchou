...
layer.config({
    extend: [
      ...
      <div class="x12 padding border-bottom height-big">
			<a href="/index.php/Admin/User/user_attest.html" class="padding text-sub">全部</a>
			<a href="/index.php/Admin/User/user_attest/status/2" class="padding <?php if($_GET['status'] == '2'): ?>text-green<?php else: ?> text-sub<?php endif; ?>">已拒绝</a>
			<a href="/index.php/Admin/User/user_attest/status/1" class="padding <?php if($_GET['status'] == '1'): ?>text-green<?php else: ?> text-sub<?php endif; ?>">已通过</a>
			<a href="/index.php/Admin/User/user_attest/status/0" class="padding <?php if($_GET['status'] == '0'): ?>text-green<?php else: ?> text-sub<?php endif; ?>">未审核</a>
...
<script>
	...
	function pass(id,status){
		$.post('/index.php/Admin/User/attest_pass',{id:id,status:status},function(ret){
			if(ret.status==1){
				layer.msg(ret.info, {
					offset: 200,
					shift: 2
