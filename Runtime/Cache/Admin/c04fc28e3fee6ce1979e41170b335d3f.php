...
<div class="padding  x12">
	...
	<div class="bg padding "><strong>股权设置</strong></div>
		...
		<div class="x9 padding text-center">
			<a href="/index.php/Admin/Item/item_add/itemid/<?php echo ($itemid); ?>" class="button button-big bg-red" >上一步</a>
...
<script>
 ...
 function save(d){
	...
	$.post('/index.php/Admin/Item/item_in_two',{
