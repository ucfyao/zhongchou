...
<div class="padding  x12">
	...
	<div class="bg padding "><strong>发起项目</strong></div>	
		<div class="height-large padding border-bottom x12">
			...
			<span class="x9">
				<select name="cid[]" class="input input-auto box-shadow-none radius-none"  id="first" onchange="loadRegion('first',2,'second','/index.php/Admin/Item/get_category');">
				...
				<select name="cid[]" class="input input-auto box-shadow-none radius-none" id="second"  onchange="loadRegion('second',3,'third','/index.php/Admin/Item/get_category');">
...
function add_item(d){
	...
	$.post('/index.php/Admin/Item/item_in',{
		name:name.val(),
		cid:last,
		tag:tag.join(','),
