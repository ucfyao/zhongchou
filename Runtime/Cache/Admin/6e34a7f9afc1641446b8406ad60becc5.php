...
$(function(){
    $('.config').click(function(){
        ...
        layer.open({
			...
			fix: true,
			title:'短信平台配置',
			content: '<?php echo U('Admin/System/sms_config');?>?type='+type
		});
    });
