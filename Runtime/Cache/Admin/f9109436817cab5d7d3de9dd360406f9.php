	...
	<script>
		function user_edit(id){
			layer.open({
				...
				maxmin: true,
				title:'编辑管理员',
				content: '/index.php/Admin/Auth/user_edit/id/'+id
			});
		}
		function show(c){
			layer.open({
				...
				fix: true, //不固定
				maxmin: true,
				content: '/index.php/Admin/Auth/user_add'
			});
		}
